...
% ══════════════════════════════════════════════════════════════════════════════
% Back-matter switches to roman numerals so References and Annex are visually
% separated from the 6-page body. Continues the counter from the TOC (which
% ended at i), so References starts at ii.
\clearpage
\pagenumbering{roman}
\setcounter{page}{2}
